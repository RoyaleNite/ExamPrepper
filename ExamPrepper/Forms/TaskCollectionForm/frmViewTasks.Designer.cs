namespace ExamPrepper.Forms.TaskCollectionForm
{
    partial class frmViewTasks
    {
        ...
        private void InitializeComponent()
        {
            ...
            tlpMainHolder.Size = new Size(604, 461);
            ...
            pnlOptionsHolder.Size = new Size(604, 60);
            ...
            tlpOptionsHolder.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tlpOptionsHolder.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tlpOptionsHolder.Size = new Size(604, 60);
            ...
            AutoScroll = true;
            AutoScrollMinSize = new Size(580, 460);
            ClientSize = new Size(604, 461);
            Controls.Add(tlpMainHolder);
            DoubleBuffered = true;
            Name = "frmViewTasks";
            Text = "Tasks View";
            Load += frmViewTasks_Load;
            Shown += frmViewTasks_Shown;
